package ar.ncode.plugin.ecs.system.scheduled;
...
import static ar.ncode.plugin.ecs.commands.ShopCommand.openShopForPlayer;
...
public class DoubleTapDetector {
    ...
    private void handleTapEnd(
        ...
        if (state.firstTapCompleteTime > 0L
            ...
            openShopForPlayer(ref, new PlayerComponents(player, playerRef, playerInfo, ref));
